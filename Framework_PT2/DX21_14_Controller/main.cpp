...
//	container.Register<Scene, Game>();
//	container.Register<IObject, Object>();
//	container.Register<Game>([](DIContainer c)
//		{
//			return new Game(c.Resolve<IObject>());
//		});
//	//ClassAを生成するとIClassBがResolve関数で動的に生成されるようDIコンテナに設定
//	//IClassBをResolve関数で生成しているが、これは先ほどRegisterで設定したClassBも動的に生成されている
//
//	//そのためClassAを生成すると生成時にClassBも生成される
//	//エラーチェック
//	auto game = container.Resolve<Scene>();
//
//	if (game != nullptr)
//	{
//		delete game;
